        ...
        <div class="cart-foot-wrap">
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
<!--                判断有没有选中数据，如果没有则禁用checkout按钮，通过checkOut函数进行跳转-->
...
<script>
  ...
  /*生命周期，组件渲染完后会调用其中的init方法*/
  mounted () {
    this.init();
  },

  /*计算属性 是实时的 实时计算的属性 不需要在data里定义*/
  computed:{
    /*全选按钮选中的状态*/
    checkAllFlag(){
      /*判断checked当前选中的数量等不等于购物车列表的length*/
      return this.checkedCount == this.cartList.length;
    },
    /*选中的数量(判断当前购物车有没有选中商品)*/
    checkedCount() {
      let i = 0
  ...
  methods: {
    ...
    editCart(flag,item) {
      if(flag=="add"){
        ...
        item.checked = item.checked=="1"?'0':'1';/*取反*/
      }
